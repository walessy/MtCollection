...
//---
   ...
   SetIndexBuffer(8 ,ExtStdDevBuffer);
//---
...
//---
   ...
   if ( startIndex > 0 )
   {
      for ( int i = startIndex; i >= 1; i-- )
      {
         ...
         /*
         ExtStdDevBuffer[i] = StdDev_Func(i, ExtBufferVWAP, i);
   		...
   		//{
   			...
   			if (DeviationBand1 > 0)
   			{
   				UpperDev1[i] = ExtBufferVWAP[i] + DeviationBand1 * ExtStdDevBuffer[i];
   				LowerDev1[i] = ExtBufferVWAP[i] - DeviationBand1 * ExtStdDevBuffer[i]; 
   			}  
   			if (DeviationBand2 > 0)
   			{
   				UpperDev2[i] = ExtBufferVWAP[i] + DeviationBand2 * ExtStdDevBuffer[i];
   				LowerDev2[i] = ExtBufferVWAP[i] - DeviationBand2 * ExtStdDevBuffer[i]; 
   			} 
   			if (DeviationBand3 > 0)
   			{            
   				UpperDev3[i] = ExtBufferVWAP[i] + DeviationBand3 * ExtStdDevBuffer[i];
   				LowerDev3[i] = ExtBufferVWAP[i] - DeviationBand3 * ExtStdDevBuffer[i];            
   			} 
   		//} 
         */
      }
