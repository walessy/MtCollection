...
int handle=0;
bool firstTick=true;
double CorrelationStat;
int init() {

  IndicatorBuffers(17); 

  SetIndexShift(0,0); SetIndexBuffer(0,closed);             SetIndexEmptyValue(0,0);  SetIndexStyle(0,DRAW_NONE); SetIndexLabel(0, NULL);
  SetIndexShift(1,0); SetIndexBuffer(1,opened);             SetIndexEmptyValue(1,0);  SetIndexStyle(1,DRAW_NONE); SetIndexLabel(1, NULL);
  SetIndexShift(2,0); SetIndexBuffer(2,highed);             SetIndexEmptyValue(2,0);  SetIndexStyle(2,DRAW_NONE); SetIndexLabel(2, NULL);
  SetIndexShift(3,0); SetIndexBuffer(3,lowed);              SetIndexEmptyValue(3,0);  SetIndexStyle(3,DRAW_NONE);  SetIndexLabel(3, NULL);
  SetIndexShift(4,0); SetIndexBuffer(4,Up_Body_Green);      SetIndexEmptyValue(4,0);  SetIndexStyle(4,DRAW_HISTOGRAM,STYLE_SOLID,3,upColor);  SetIndexLabel(4, NULL);
  SetIndexShift(5,0); SetIndexBuffer(5,Dn_Body_Red);        SetIndexEmptyValue(5,0);  SetIndexStyle(5,DRAW_HISTOGRAM,STYLE_SOLID,3,dnColor);   SetIndexLabel(5, NULL);
  SetIndexShift(6,0); SetIndexBuffer(6,EqBodyBuffer);       SetIndexEmptyValue(6,0);  SetIndexStyle(6,DRAW_HISTOGRAM,STYLE_SOLID,3,White);  SetIndexLabel(6, NULL);
  SetIndexShift(7,0); SetIndexBuffer(7,Bg_Body_Black);      SetIndexEmptyValue(7,0);  SetIndexStyle(7,DRAW_HISTOGRAM,STYLE_SOLID,3,bkg_color);  SetIndexLabel(7, NULL);
  SetIndexShift(8,0); SetIndexBuffer(8,Up_Wick_Green);      SetIndexEmptyValue(8,0);  SetIndexStyle(8,DRAW_HISTOGRAM,STYLE_SOLID,1,upColor);   SetIndexLabel(8, NULL);
  SetIndexShift(9,0); SetIndexBuffer(9,Dn_Wick_Red);        SetIndexEmptyValue(9,0);  SetIndexStyle(9,DRAW_HISTOGRAM,STYLE_SOLID,1,dnColor);  SetIndexLabel(9, NULL);
  SetIndexShift(10,0); SetIndexBuffer(10,EqShadowBuffer);    SetIndexEmptyValue(10,0); SetIndexStyle(10,DRAW_HISTOGRAM,STYLE_SOLID,1,White);  SetIndexLabel(10, NULL);
  SetIndexShift(11,0); SetIndexBuffer(11,Bg_Wick_Black);     SetIndexEmptyValue(11,0); SetIndexStyle(11,DRAW_HISTOGRAM,STYLE_SOLID,1,bkg_color);  SetIndexLabel(11, NULL);
  SetIndexShift(12,0); SetIndexBuffer(12,Dn_Body_Green);     SetIndexEmptyValue(12,0); SetIndexStyle(12,DRAW_HISTOGRAM,STYLE_SOLID,3,upColor);  SetIndexLabel(12, NULL);
  SetIndexShift(13,0); SetIndexBuffer(13,Up_Body_Red);       SetIndexEmptyValue(13,0); SetIndexStyle(13,DRAW_HISTOGRAM,STYLE_SOLID,3,dnColor);  SetIndexLabel(13, NULL);
  SetIndexShift(14,0); SetIndexBuffer(14,Dn_Wick_Green);     SetIndexEmptyValue(14,0); SetIndexStyle(14,DRAW_HISTOGRAM,STYLE_SOLID,1,upColor);  SetIndexLabel(14, NULL);
  SetIndexShift(15,0); SetIndexBuffer(15,Up_Wick_Red);       SetIndexEmptyValue(15,0); SetIndexStyle(15,DRAW_HISTOGRAM,STYLE_SOLID,1,dnColor);  SetIndexLabel(15, NULL);
  SetIndexShift(16,0); SetIndexBuffer(16,correlation);       SetIndexEmptyValue(16,0); SetIndexStyle(16,DRAW_LINE, STYLE_SOLID, 1, Yellow);  SetIndexLabel(16, NULL);
...
void calcCorr(){
   ...
   for (int i=Bars-1-corrPeriod; i>=0; i--){
       ...
       CorrelationStat=correlation [i];
  }
   
      }
   

      IndicatorShortName("Cummulative Delta "+DoubleToString(CorrelationStat)+" ");
