...
extern bool Show_CurrDaily = false;
extern int Shift_CurrDaily_LABEL = 0;
extern bool Show_CurrWeekly = false;
extern int Shift_CurrWeekly_LABEL = 0;
extern bool Show_CurrMonthly = false;
extern int Shift_CurrMonthly_LABEL = 0;
extern color line_color_CurrDailyUPPER = Red;
extern color line_color_CurrDailyLOWER = Red;
extern color line_color_CurrWeeklyUPPER = Blue;
extern color line_color_CurrWeeklyLOWER = Blue;
extern color line_color_CurrMonthlyUPPER = Green;
extern color line_color_CurrMonthyLOWER = Green;
...
extern color line_color_PreviousDaily = Blue;
...
void Create_DailyLineMHI(string MLine, double start, double end,double w, double s,color clr)
 ...
 //CurrDaily levels
  ...
  ObjectSetText("HILO", "                                   Daily High "+DoubleToStr(DHigh,Digits)+"", 10, "Arial", line_color_CurrDailyUPPER);
  ...
  ObjectSetText("HILO1", "                                  Daily Low "+DoubleToStr(DLow,Digits)+" ", 10, "Arial", line_color_CurrDailyLOWER);
  ...
  ObjectSetText("HILO2", "                                  Weekly High "+DoubleToStr(WHigh,Digits)+" ", 10, "Arial", line_color_CurrWeeklyUPPER);
  ...
  ObjectSetText("HILO3", "                                  Weekly Low "+DoubleToStr(WLow,Digits)+" ", 10, "Arial", line_color_CurrWeeklyLOWER);
  ...
  ObjectSetText("HILO4", "                                  Monthly High "+DoubleToStr(MHigh,Digits)+" ", 10, "Arial", line_color_CurrMonthlyUPPER);
  ...
  ObjectSetText("HILO5", "                                  Monthly Low "+DoubleToStr(MLow,Digits)+" ", 10, "Arial", line_color_CurrMonthyLOWER);
  ...
  ObjectSetText("HILOP", "Prev / Daily High "+DoubleToStr(DHi,Digits)+" ", 10, "Arial", line_color_PreviousDaily);
  ...
  ObjectSetText("HILO1P", "Prev / Daily Low "+DoubleToStr(DLo,Digits)+" ", 10, "Arial", line_color_PreviousDaily);
  ...
  ObjectSetText("HILO2P", "Prev / Weekly High "+DoubleToStr(WHi,Digits)+" ", 10, "Arial", line_color_PreviousWeekly);
  ...
  ObjectSetText("HILO3P", "Prev / Weekly Low "+DoubleToStr(WLo,Digits)+" ", 10, "Arial", line_color_PreviousWeekly);
  ...
  ObjectSetText("HILO4P", "Prev / Monthly High "+DoubleToStr(MHi,Digits)+" ", 10, "Arial", line_color_PreviousMonthly);
  ...
  ObjectSetText("HILO5P", "Prev / Monthly Low "+DoubleToStr(MLo,Digits)+" ", 10, "Arial", line_color_PreviousMonthly);
  ...
  ObjectSetText("PIVOTD", "D / Pivot "+DoubleToStr(PD,Digits)+" ", 10, "Arial", Daily_Pivot_color);
  ...
  ObjectSetText("PIVOTW", "W / Pivot "+DoubleToStr(PW,Digits)+" ", 10, "Arial", Weekly_Pivot_color);
  ...
  ObjectSetText("PIVOTM", "M / Pivot "+DoubleToStr(PM,Digits)+" ", 10, "Arial", Monthly_Pivot_color);
