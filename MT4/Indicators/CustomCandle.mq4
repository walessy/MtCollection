...
int start(){
if(TimeFrame>1440)
{Comment("\n"," TimeFrame больший D1 не поддерживается!!!");return(0);}
if(Period()>240)
{Comment("\n"," Period больший H4 не поддерживается!!!");return(0);}
if(TimeFrame<=Period()||MathMod(TimeFrame,Period())!=0)
{Comment("\n"," Необходим TimeFrame больший и кратный M",Period(),);return(0);}
