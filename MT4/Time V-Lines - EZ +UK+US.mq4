...
input string Line_1_Time = "06:00";     // Line 1  Time
...
input string Line_2_Time = "07:00";     // Line 2  Time 
input LW     Line_2_Width = 1;          // Line 2  Width
input ENUM_LINE_STYLE Line_2_Style = 1; // Line 2  Style

input color  Line_3_Color = Magenta;    // Line 3  Color
input bool   Line_3_Visible = true;    // Line 3  Visible
input string Line_3_Time = "08:00";     // Line 3  Time
input LW     Line_3_Width = 1;          // Line 3  Width
input ENUM_LINE_STYLE Line_3_Style = 1; // Line 3  Style

input color  Line_4_Color = Green;    // Line 4  Color
input bool   Line_4_Visible = true;    // Line 4  Visible
input string Line_4_Time = "11:30";     // Line 4  Time
input LW     Line_4_Width = 1;          // Line 4  Width
input ENUM_LINE_STYLE Line_4_Style = 1; // Line 4  Style

input color  Line_5_Color = Green; // Line 5  Color
input bool   Line_5_Visible = true;    // Line 5  Visible
input string Line_5_Time = "12:30";     // Line 5  Time
input LW     Line_5_Width = 1;          // Line 5  Width
input ENUM_LINE_STYLE Line_5_Style = 1; // Line 5  Style

input color  Line_6_Color = Magenta; // Line 6  Color
input bool   Line_6_Visible = true;    // Line 6  Visible 
input string Line_6_Time = "13:30";     // Line 6  Time
input LW     Line_6_Width = 1;          // Line 6  Width
input ENUM_LINE_STYLE Line_6_Style = 1; // Line 6  Style  

input color  Line_7_Color = Gray; // Line 7  Color
input bool   Line_7_Visible = true;    // Line 7  Visible 
input string Line_7_Time = "01:00";     // Line 7  Time
input LW     Line_7_Width = 1;          // Line 7  Width
input ENUM_LINE_STYLE Line_7_Style = 1; // Line 7  Style  
//----------------------------------------------------- 
// DEFAULT INPUTS : END 
...
int OnInit()
{
  ...
  for (int i=0; i<Historical_Days; i++) 
  {
     ...
     CreateObjects("T7"+IntegerToString(i), Line_7_Color);
     ObjectSet("T7"+IntegerToString(i), OBJPROP_WIDTH, Line_7_Width);
     ObjectSet("T7"+IntegerToString(i), OBJPROP_STYLE, Line_7_Style);
  }
...
void DeleteObjects() 
{
  for (int i=0; i<Historical_Days; i++) 
  {
    ...
    ObjectDelete("T7"+IntegerToString(i));
  }
}
...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
 {
   ...
   for (int i=0; i<Historical_Days; i++) 
   {
      ...
      if(Line_7_Visible == true)
      {
         DrawObjects(dt, "T7"+IntegerToString(i), Line_7_Time, T7_End);
      }
