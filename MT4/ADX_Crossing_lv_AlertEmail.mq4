...
int flagval1 = 0;
int flagval2 = 0;
double nowmain,b4plusdi,nowplusdi,b4minusdi,nowminusdi;
...
//      if (GlobalVariableGet("LastAlert"+Symbol()+Period()) > -0.5)
//      {
        if (SoundON) Alert("ADX SELL signal at Ask=",Ask,", Bid=",Bid,", Date=",TimeToStr(CurTime(),TIME_DATE)," ",TimeHour(CurTime()),":",TimeMinute(CurTime())," Symbol=",Symbol()," Period=",Period());
